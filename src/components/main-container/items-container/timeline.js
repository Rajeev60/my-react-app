                ...
                <div className="left-status-container">
                    ...
                    <div className="scan-div">
                        <div className="destination"> 
                            <svg id="Group_13" data-name="Group 13" xmlns="http://www.w3.org/2000/svg" width="21.537" height="28.592" viewBox="0 0 21.537 28.592">
                        ...
                        <div className="dest-space"></div>
                    </div>
                    <div className="scan-div">
                        <div className="dots">
                            <div className="dot"></div>
                            <div className="dot-line">_______</div>
                        </div>
                        <div className="right-summary right-summary-active">
                            <div className="curr-status">Delivered</div>
                            <div className="status-date">04-07-20</div>                            
                            <div className="status-time">14:00</div>
                        </div>
                    </div>
                    <div className="scan-div">
                        <div className="dots">
                        ...
                        <div className="right-summary">
                            <div className="curr-status">Out for Delivery</div>
                            <div className="status-date">04-07-20</div>                            
                            <div className="status-time">14:00</div>
                        </div>
                    </div>
                    <div className="scan-div">
                        ...
                        <div className="right-summary">
                            <div className="curr-status">Arrived at Mysore</div>
                            <div className="status-date">04-07-20</div>                            
                            <div className="status-time">14:00</div>
                        </div>
                    </div>
                    <div className="scan-div">
                        ...
                        <div className="right-summary">
                            <div className="curr-status">Arrived at Bangalore</div>
                            <div className="status-date">04-07-20</div>                            
                            <div className="status-time">14:00</div>
                        </div>
                    </div>
                    <div className="scan-div">
                        ...
                        <div className="right-summary">
                            <div className="curr-status">Transit to Next Hub</div>
                            <div className="status-date">04-07-20</div>                            
                            <div className="status-time">14:00</div>
                        </div>
                    </div>
                    <div className="scan-div">
                        <div className="destination"> 
                            <svg xmlns="http://www.w3.org/2000/svg" width="22.467" height="26.849" viewBox="0 0 22.467 26.849">
